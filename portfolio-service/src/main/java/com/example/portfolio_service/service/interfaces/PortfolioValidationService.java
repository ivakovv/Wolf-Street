...
public interface PortfolioValidationService {
    ...
    void processExecutedDeal(Long portfolioBuyId, Long portfolioSaleId, Long instrumentId, Long count, BigDecimal lotPrice);
    void processCancelledDeal(Long portfolioBuyId, Long portfolioSaleId, Long instrumentId, Long count, BigDecimal lotPrice);
}
