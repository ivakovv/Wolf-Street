...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, DealMessages.ExecutedDealMessage> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, DealMessages.ExecutedDealMessage> kafkaListenerContainerFactory
